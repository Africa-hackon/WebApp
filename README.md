...
3. Install the PortSwigger CA certificate — see [burp-ca-setup.md](burp-ca-setup.md)

---

## Checklists

- [OWASP Top 10 Web & API Security](owasp-checklist.md)
- [Web Application Penetration Testing](webapp-pentest-checklist.md)
